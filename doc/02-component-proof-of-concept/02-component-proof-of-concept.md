...
***Answer: I will be going with the `Clipboard` component fromt part 1 because of its simplicity
and the fact that it can do interesting things while being useful. The secondary methods
will also be easy to implement. The whole thing will be within my grasp of implementing
without too much trouble because of the simple idea.***
